...
//------------------------------- buildTree ----------------------------------
// Description: The method buildTree reads strings from a line in the given
// file and adds the strings to the given binary search tree.
//
// Pre: Each line in the file must ends with "$$", which signals the end of a
// line and would not be added to the tree.
//
// Post: The strings from a line in the given file are added to the given
// binary search tree.
//
// Parameter: T, which is the binary search tree to add strings to.
//
// Parameter: infile, which is the file to read.
